...
export async function getUsersList() { return []; }
export async function createNewUser(u: any) { return false; }
export async function removeUser(id: string) { return false; }
